...
function MachineOperatorNavbar() {
  ...
  return (
    <div className="bg-[#2f323a] flex items-center justify-between p-3 text-white">
      <div className="flex items-center text-[16px] font-semibold space-x-4">
        ...
        <button className="">Machines</button>
        <button>Daily Machine Log</button>
        <button>Minor Issue Reporting</button>
        <button>Breakdown Creation</button>
        <button>Shift Tasks</button>
      </div>
...
export default MachineOperatorNavbar;
