  ...
  return (
    <div className="bg-[#2f323a] flex items-center justify-between p-3 text-white">
      <div className="flex items-center text-[16px] font-semibold space-x-4">
        ...
        <button>Safety Checks</button>
        <button>Incident Reports</button>
        <button>Safety Training</button>
        <button>Compliance Management</button>
      </div>
...
export default SafetyEngineerNavbar;
