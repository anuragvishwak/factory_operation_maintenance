  ...
  return (
    <div className="bg-[#2f323a] flex items-center justify-between p-3 text-white">
      <div className="flex items-center text-[16px] font-semibold space-x-4">
        ...
        <button>Current Stock Levels</button>
        <button>Material Inward</button>
        <button>Material Outward</button>
        <button>Purchase Requests</button>
        <button>Purchase Orders</button>
        <button>Supplier Management</button>
        <button>Material Usage Logs</button>
        <button>Stock Audit</button>
        <button>Store Reports</button>
      </div>
...
export default StoreInventoryNavbar;
