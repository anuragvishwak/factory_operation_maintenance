...
function QualityEngineerNavbar() {
  ...
  return (
    <div className="bg-[#2f323a] flex items-center justify-between p-3 text-white">
      <div className="flex items-center text-[16px] font-semibold space-x-4">
        ...
        <button>Product Quality Checks</button>
        <button>Machine Calibration</button>
        <button>Quality Reports</button>
      </div>
...
export default QualityEngineerNavbar;
